...
def run_bot(data_account, recover=1):
    ...
    try:
        ...
        slug = f"{nama_modif}-unblocked-games-play-on-{random_string(6)}"
        ...
        try:
            konten = f'{kw} is a popular website that offers a wide variety of games that can be played in environments where access to gaming sites is typically restricted, such as schools and workplaces \n  {kw} Enjoy playing all your favorite casual.. \n'
            driver.find_element(
                By.XPATH,
